                       ...
                       <div class="col-md-6">
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                ...
                                <input id="role" type="hidden" class="form-control" name="role" value="Employer">
                                <input id="category" type="hidden" class="form-control" name="category" value="employer">
                      ...
                      <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                          ...
                          <div class="form-group{{ $errors->has('regNo') ? ' has-error' : '' }}">
                              <label for="regNo" class="col-md-4 control-label">ID No:</label>
